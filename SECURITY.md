...
We take the security of Node-OPCUA Crypto very seriously. If you believe you have found a security vulnerability, please do **NOT** file a public GitHub issue, and do **NOT** post details publicly.
...
1. Go to the **[node-opcua/node-opcua-crypto](https://github.com/node-opcua/node-opcua-crypto)** repository on GitHub.
